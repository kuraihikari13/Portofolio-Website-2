...
?>
    ...
    <form method=POST action="controller/edit.php">
        ...
        <div id="viewedit" class=" lg:mt-20 lg:mx-20 p-4 pb-12  bg-white">
            <div>
                <div>
                    <div class=" px-4 pt-4 bg-white flex justify-end ">
                        <a href="muridorg.php?id=<?php echo $d['id']; ?>&&kelas=<?php echo $d['kelas']; ?>" class="bg-blue-500 flex space-x-2 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                            <h1>Cancel Edit</h1>
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    <div class="shadow-md space-y-2 p-4 mb-12 bg-white lg:flex lg:space-x-12">
                        <div id="bio" class="flex space-x-4 ">
                            <div>
                                <label class="absolute cursor-pointer ">


                                    <svg xmlns="http://www.w3.org/2000/svg" class="relative h-6 w-6 bg-white hover:stroke-blue-800 " fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                    </svg><input type="file" class="opacity-0" />
                        ...
                        <div class="lg:w-[500px]  border-8 bg-blue-800 border-indigo-500">
                            ...
                            <h1 class=" focus:border-blue-800 text-center text-6xl font-serif text-yellow-400"> 1</h1>
                            <h1 class=" py-4 focus:border-blue-800 text-center text-white text-base">
                                "Selamat <b>Adam Alfatih</b> Kamu meraih Ranking <b><i>1</i></b> dari <b><i>30</i></b> siswa di kelas I,
                                dan berdasarkan total nilai kamu, kamu masuk kelas II A di tahun depan"
                            </h1>
                            <h1 class="px-2 focus:border-blue-800 text-center border-2 border-amber-500 bg-amber-300 text-2xl font-bold font-serif"> KELAS II A</h1>
                        </div>
                    ...
                    <div class="space-y-12">
                        ...
                        <form>
                            <table id="table_id3" class="display bg-white ">
                                <thead>
                                    <tr>
                                        <th>Mata Pelajaran</th>
                                        <th>Nilai</th>
                                        <input hidden name="kelas" value="<?php echo $d['kelas']; ?>" />
                                        <input hidden name="id" value="<?php echo $d['id']; ?>" />
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td>Agama</td>
                                        <td> <input class="lg:w-[400px] py-2 px-4  focus:border-blue-800" placeholder="<?php echo $d['agama'];?>" name="agama" value="<?php echo $d['agama'];?>" type="text"></td>
                                    </tr>
                                    <tr>
                                        <td>PPKN</td>
                                        <td id="mp2"><input placeholder="<?php echo $d['ppkn'];?>" name="ppkn" value="<?php echo $d['ppkn'];?>" class="lg:w-[400px] py-2 px-4  focus:border-blue-800" type="text"></td>

                                    </tr>
                                    <tr>
                                        <td>Matematika</td>
                                        <td id="mp3"><input placeholder="<?php echo $d['matematika'];?>" name="matematika" value="<?php echo $d['matematika'];?>" class="lg:w-[400px] py-2 px-4  focus:border-blue-800" type="text"></td>

                                    </tr>
                                    <tr>
                                        <td>Bahasa Inggris</td>
                                        <td id="mp4"><input placeholder="<?php echo $d['inggris'];?>" value="<?php echo $d['inggris'];?>" class="lg:w-[400px] py-2 px-4  focus:border-blue-800" name="inggris" type="text"></td>

                                    </tr>
                                    <tr>
                                        <td>Bahasa Indonesia</td>
                                        <td id="mp5"><input placeholder="<?php echo $d['indonesia'];?>" value="<?php echo $d['indonesia'];?>" class="lg:w-[400px] py-2 px-4  focus:border-blue-800" name="indonesia" type="text"></td>

                                    </tr>
                                    <tr>
                                        <td>QIROAT</td>
                                        <td id="mp6"><input placeholder="<?php echo $d['qiroat'];?>" value="<?php echo $d['qiroat'];?>" class="lg:w-[400px] py-2 px-4  focus:border-blue-800" name="qiroat" type="text"></td>

                                    </tr>
                                    <tr>
                                        <td>SBDP</td>
                                        <td id="mp7"><input placeholder="<?php echo $d['sbdp'];?>" value="<?php echo $d['sbdp'];?>" class="lg:w-[400px] py-2 px-4  focus:border-blue-800" name="sbdp" type="text"></td>

                                    </tr>
                                    <tr>
                                        <td>PJOK</td>
                                        <td id="mp8"><input placeholder="<?php echo $d['pjok'];?>" value="<?php echo $d['pjok'];?>" class="lg:w-[400px] py-2 px-4  focus:border-blue-800" type="text" name="pjok"></td>
                    ...
                    <div class="space-y-12 mt-24">
                        ...
                        <table id="table_id4" class="display bg-white ">
                            <thead>
                                <tr>
                                    <th>Sikap</th>
                                    <th>Nilai</th>
                            ...
                            <tbody>
                                <tr>
                                    <td>Karakter</td>
                                    <td id="kp1"><input placeholder="<?php echo $d['karakter'];?>" value="<?php echo $d['karakter'];?>"class="lg:w-[400px] py-2 px-4  focus:border-blue-800" type="text" name="karakter"></td>

                                </tr>
                                <tr>
                                    <td>Sosiabilitas</td>
                                    <td id="kp2"><input placeholder="<?php echo $d['sosiabilitas'];?>" value="<?php echo $d['sosiabilitas'];?>" class="lg:w-[400px] py-2 px-4  focus:border-blue-800" type="text" name="sosiabilitas"></td>

                                </tr>
                                <tr>
                                    <td>Stabilitas</td>
                                    <td id="kp3"><input placeholder="<?php echo $d['stabilitas'];?>" value="<?php echo $d['stabilitas'];?>" class="lg:w-[400px] py-2 px-4  focus:border-blue-800" type="text"name="stabilitas"></td>

                                </tr>
                                <tr>
                                    <td>Emosi</td>
                                    <td id="kp4"><input placeholder="<?php echo $d['emosi'];?>" value="<?php echo $d['emosi'];?>" class="lg:w-[400px] py-2 px-4  focus:border-blue-800" type="text" name="emosi"></td>

                                </tr>

                            </tbody>
                        </table>
                        <div onclick="refresh()" class="w-full flex justify-end mt-12">
